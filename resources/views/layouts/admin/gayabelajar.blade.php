...
@section('title','Gaya Belajar User')
                                        ...
                                        <table class="table table-xs mb-0">
                                            <thead>
                                                <tr>
                                                    <th>Mahasiswa</th>
                                                    <th>Score Active</th>
                                                    <th>Score Reflective</th>
                                                    <th>Score Sensing</th>
                                                    <th>Score Intuitive</th>
                                                    <th>Score Visual</th>
                                                    <th>Score Verbal</th>
                                                    <th>Score Sequential</th>
                                                    <th>Score Global</th>
                                                    <th>V_Active</th>
                                                    <th>V_Reflective</th>
                                                    <th>V_Sensing</th>
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td><img src="{{asset('storage')}}/foto/mahasiswa/{{ $ds->fotomhs }}" class=" rounded-circle mr-3" alt="">{{$ds->nim}}</br>{{$ds->namadepan." ". $ds->namabelakang}}</td>
                                                    <td>{{ $ds->score_active }}</td>
                                                    <td>{{ $ds->score_reflective }}</td>
                                                    <td>{{ $ds->score_sensing }}</td>
                                                    <td>{{ $ds->score_intuitive }}</td>
                                                    <td>{{ $ds->score_visual }}</td>
                                                    <td>{{ $ds->score_verbal }}</td>
                                                    <td>{{ $ds->score_sequential }}</td>
                                                    <td>{{ $ds->score_global }}</td>
                                                    <td>{{ $ds->v_active }}</td>
                                                    <td>{{ $ds->v_reflective }}</td>
                                                    <td>{{ $ds->v_sensing }}</td>
                                                    <td>{{ $ds->v_intuitive }}</td>
                                                    <td>{{ $ds->v_visual }}</td>
                                                    <td>{{ $ds->v_verbal }}</td>
                                                    <td>{{ $ds->v_sequential }}</td>
                                                    <td>{{ $ds->v_global }}</td>
                                                    <td>{{ $ds->dominan }}</td>
                                                    <td>{{ $ds->level }}</td>
                                                </tr>
