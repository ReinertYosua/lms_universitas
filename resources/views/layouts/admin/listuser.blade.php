                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-xs mb-0">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td><img src="{{asset('storage')}}/foto/dosen/{{ $dd->fotodsn }}" class=" rounded-circle mr-3" alt="">{{ $dd->name }}</td>
                                                    <td>{{ $dd->email }}</td>
                                                    <td>
                                                        @if($dd->usertype == 2)
                                                        <span>Dosen</span>
                                                    ...
                                                    <td>    
                                                        <form action="{{ route('approve.user') }}" method="post">
                                                            @csrf
                                                            @if( $dd->approve == "N")
                                                                <input type="hidden" name="id" value="{{ $dd->dsn_uid }}">
                                                                <input type="hidden" name="approve_val" value="Y">
                                                                <input type="submit" class="btn btn-warning" value="{{ $dd->approve }}">
                                                            @elseif($dd->approve == "Y")
                                                                <input type="hidden" name="id" value="{{ $dd->dsn_uid }}">
                                                                <input type="hidden" name="approve_val" value="N">
                                                                <input type="submit" class="btn btn-success" value="{{ $dd->approve }}">
                                                            @endif
                                                        </form>  
                                                    </td>
                                                    <td>{{ $dd->active }}</td>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-xs mb-0">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td><img src="{{asset('storage')}}/foto/mahasiswa/{{ $dm->fotomhs }}" class=" rounded-circle mr-3" alt="">{{ $dm->name }}</td>
                                                    <td>{{ $dm->email }}</td>
                                                    <td>
                                                        @if($dm->usertype == 3)
                                                        <span>Mahasiswa</span>
                                                    ...
                                                    <td> 
                                                        <form action="{{ route('approve.user') }}" method="post">
                                                            @csrf
                                                            @if( $dm->approve == "N")
                                                                <input type="hidden" name="id" value="{{ $dm->mhs_uid }}">
                                                                <input type="hidden" name="approve_val" value="Y">
                                                                <input type="submit" class="btn btn-warning" value="{{ $dm->approve }}">
                                                            @elseif($dm->approve == "Y")
                                                                <input type="hidden" name="id" value="{{ $dm->mhs_uid }}">
                                                                <input type="hidden" name="approve_val" value="N">
                                                                <input type="submit" class="btn btn-success" value="{{ $dm->approve }}">
                                                            @endif
                                                        </form>     
