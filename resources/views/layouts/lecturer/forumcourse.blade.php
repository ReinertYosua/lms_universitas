    ...
    <div class="row page-titles mx-0">
        <div class="col p-md-0">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="{{ route('forum.dosen') }}">Forum</a></li>
                                ...
                                <div role="tabpanel" class="tab-pane fade {{($loop->iteration==$lastsessionscore)?'active':''}} show mt-2" id="tab{{$loop->iteration}}" aria-labelledby="public-tab" aria-expanded="true">
                                    <div class="row">
                                        <div class="col-lg-7">
                                            ...
                                            <a href="{{ route('createforum.dosen', ['kodemk'=>encrypt($matkul[0]->kode_matakuliah), 'namamk'=>$matkul[0]->nama_matakuliah,'session'=>$dt->session,'materi'=>$dt->materi,'periode'=>$periode]) }}" class="btn mb-1 btn-primary">Create Thread</a>
                                        </div>
                                    </div>
                                    </br>
                                    <div class="row">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <div class="row">
                                                                    <div class="col-lg-12">
                                                                        <a href="{{ route('createforum.dosen', ['kodemk'=>encrypt($matkul[0]->kode_matakuliah), 'namamk'=>$matkul[0]->nama_matakuliah,'session'=>$dt->session,'materi'=>$dt->materi,'periode'=>$periode]) }}">
