    ...
    <div class="row page-titles mx-0">
        <div class="col p-md-0">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="{{ route('forumcourse.dosen',['trkodemtk'=> encrypt($kodemk), 'periode'=>encrypt($periode)]) }}">Matakuliah</a></li>
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="{{ route('forumcourse.dosen',['trkodemtk'=> encrypt($kodemk), 'periode'=>encrypt($periode)]) }}" class="form-profile">
